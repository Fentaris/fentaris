...
- ac323f3: Harden Telegram approvals with chat-bound callback validation, signed callback payloads, webhook secret checks, and fail-closed delivery failures by default.
