...
description: "The centralized MCP proxy for routing, policy, auth, and observability."
---

<div className="px-4 py-8 mt-10 lg:pb-16 max-w-5xl mx-auto">
  <div className="text-center">
    <img noZoom src="/assets/logo-light.svg" className="block dark:hidden mx-auto h-14 w-auto" alt="Fentaris" />
    <img noZoom src="/assets/logo-dark.svg" className="hidden dark:block mx-auto h-14 w-auto" alt="Fentaris" />
  </div>
...
2. **Understand the moving parts** in [Architecture](/concepts/architecture) and [Servers and transports](/concepts/servers-and-transports).
...
<Steps>
  <Step title="Install @fentaris/core">
    ...
    This gives you the Fentaris SDK, high-level proxy declarations, transport helpers, governance helpers, and runtime APIs.
  </Step>

  <Step title="Define upstream MCP servers">
    ```ts theme={null}
    ...
    The `mcp(...)` declaration gives Fentaris a stable server name, display label, and transport configuration.
  </Step>
