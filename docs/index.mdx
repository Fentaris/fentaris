...
<div className="fentaris-home px-4 py-8 mt-10 lg:pb-16 max-w-5xl mx-auto">
  ...
  <div className="px-6 lg:px-0 mt-4">
    <CardGroup cols={3}>
      ...
      <Card title="API map" icon="search" href="/reference-auto/api-map">
        Navigate the generated API reference by domain.
      </Card>
    </CardGroup>
  </div>
</div>
...
<CardGroup cols={3}>
  ...
  <Card title="API reference map" icon="search" href="/reference-auto/api-map">
    Shortcuts into the generated API reference.
  </Card>
</CardGroup>
