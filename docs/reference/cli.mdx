...
Inside a project using the integrated local control plane, these commands use the owner-protected local operator channel automatically. Outside that project, set `FENTARIS_EDGE_CONTROL_PLANE_URL` to use a remote management API.
