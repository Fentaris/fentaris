...
- [Use Codex Skills](#use-codex-skills)
...
Fentaris includes optional Codex skills for assisted setup and project development. Install them with:

```bash
npx @fentaris/codex-skills install
```

Restart Codex after installation, then ask it to use `$fentaris-project-setup` for a guided proxy setup or `$fentaris-app-development` for changes inside an existing Fentaris app.

See the [Codex skills guide](https://fentaris.mintlify.app/getting-started/codex-skills) for install options and example prompts.
...
- [Codex skills](https://fentaris.mintlify.app/getting-started/codex-skills): install optional setup and development skills for Codex.
