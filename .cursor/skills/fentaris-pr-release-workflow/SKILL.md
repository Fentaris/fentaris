...
- When Cursor is asked to make a PR, Cursor is responsible for adding the changeset unless the user explicitly says no release is needed.
...
When Cursor makes commits or PRs in this repo:
