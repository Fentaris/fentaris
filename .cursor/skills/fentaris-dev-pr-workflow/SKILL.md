...
description: Use in the Fentaris repository whenever Cursor is asked to implement a new code change, OpenSpec change, fix, refactor, feature, branch, commit, or pull request intended to merge into dev.
license: MIT
compatibility: Requires GitButler for preferred branch, stage, commit, and pull request operations.
metadata:
  author: fentaris
  version: "1.0"
  generatedBy: "fentaris"
---
...
3. Branch names should use `cursor/` and a short kebab-case task name, for example `cursor/add-auth-checks`.
